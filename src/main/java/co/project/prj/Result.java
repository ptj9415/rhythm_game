...
public class Result {
	...
	public void draw(Graphics2D g) {
		...
		if (bgm.getTime() >= 4000 || step2On == true) {
			...
			g.setColor(new Color(200, 255, 200));
			g.setFont(new Font("Elephant", Font.BOLD, 25));
			g.drawString("Score : " + String.valueOf(score), 440, 370);
		}
		...
		if (bgm.getTime() >= 5500 || step3On == true) {
			...
			g.drawString("Rank : " + String.valueOf(rank), 760, 390);
		}
		...
		if (bgm.getTime() >= 6500 || step4On == true) {
			...
			g.setFont(new Font("Elephant", Font.BOLD, 27));
			g.drawString("next game ENTER", 500, 450);
		}
